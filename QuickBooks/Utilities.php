...
class QuickBooks_Utilities
{
     ...
     */
    public static function parseDSN($dsn, $defaults = [], $part = null)
    {
     ...
     */
    public static function driverFactory($dsn_or_conn, $config = [], $hooks = [], $log_level = QUICKBOOKS_LOG_NORMAL)
    {
     ...
     * @return boolean
     */
    public static function initialize($dsn, $driver_options = [], $init_options = [])
    {
     ...
     * @return boolean
     */
    public static function initialized($dsn, $driver_options = [])
    {
        $Driver = QuickBooks_Utilities::driverFactory($dsn, $driver_options);
