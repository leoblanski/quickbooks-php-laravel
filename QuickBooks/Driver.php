...
abstract class QuickBooks_Driver
{
    ...
    */
    ...
    {
        $err = '';
        $this->_callHook(QUICKBOOKS_DRIVER_HOOK_AUTHDEFAULT, null, $err, []);
    ...
    {
        $err = '';
        $this->_callHook(QUICKBOOKS_DRIVER_HOOK_AUTHRESOLVE, $ticket, $err, []);
    ...
    final public function authLast($username)
    {
        $ticket = null;
        $err = '';
        $this->_callHook(QUICKBOOKS_DRIVER_HOOK_AUTHLAST, $ticket, $err, []);
    ...
    {
        $err = '';
        $this->_callHook(QUICKBOOKS_DRIVER_HOOK_AUTHCHECK, $ticket, $err, []);
    ...
    {
        $err = '';
        $this->_callHook(QUICKBOOKS_DRIVER_HOOK_AUTHLOGOUT, $ticket, $err, []);
     ...
     */
    abstract protected function _initialize($options = []);
