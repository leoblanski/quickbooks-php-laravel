...
class QuickBooks_MerchantService
{
     ...
     * @var string
     */
    public const TYPE_VOIDORREFUND = 'VoidOrRefund';

    public const TYPE_WALLETADD = 'WalletAdd';

    public const TYPE_WALLETMOD = 'WalletMod';

    public const TYPE_WALLETDEL = 'WalletDelete';

    public const TYPE_WALLETQUERY = 'WalletQuery';

    public const TYPE_WALLETAUTHORIZE = 'WalletAuthorize';

    public const TYPE_WALLETCHARGE = 'WalletCharge';

    public const TYPE_CHECK_DEBIT = 'CheckDebit';

    /**
     * Constant for the NotAvailable response some fields return
     * @var string
     */
    public const NOTAVAILABLE = 'NotAvailable';
    
    public const AVS_NOTAVAILABLE = 'NotAvailable';
    ...
    public const AVS_PASS = 'Pass';

    public const FAIL = 'Fail';
    
    public const AVS_FAIL = 'Fail';
    ...
    public const MODE_INTERNET = 'Internet';
    
    public const MODE_TELEPHONE = 'Telephone';
    
    public const MODE_SIGNED = 'SignedAuthOnFile';
    
    public const MODE_MAILED = 'Mailed';
    
    public const MODE_WITHRECEIPT = 'InPersonWithReceipt';
    
    public const MODE_WITHOUTRECEIPT = 'InPersonNoReceipt';
    ...
    */
     ...
     * IMPORTANT NOTE: This
     */
    public const TEST_AVSZIPCVVFAIL = 'configid=10000_avscvdfail';

    public const TEST_COMMUNICATIONERROR = 'configid=10200_comm';
...
*/
    ...
    protected function _parseResponse($type, $path, $xml, &$errnum, &$errmsg)
    {
        ...
        if ($type == QuickBooks_MerchantService::TYPE_WALLETMOD || $type == QuickBooks_MerchantService::TYPE_WALLETDEL) {
    ...
    protected function _createCreditCardXML($Card, $amount, $salestax, $is_card_present, $is_ecommerce, $is_recurring, $is_mobile, $include_address_data = true, $include_amounts = true, $include_card_number = true, $include_card_cvv = true, $include_card_dates = true)
    {
        ...
        if ($include_address_data) {
            ...
            $xml .= '			<CreditCardPostalCode>' . substr(str_replace(['-', ' ', '.'], '', $Card->getPostalCode()), 0, 9) . '</CreditCardPostalCode>' . QUICKBOOKS_CRLF;
        }
