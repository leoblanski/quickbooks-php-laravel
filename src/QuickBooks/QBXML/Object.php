...
abstract class QuickBooks_QBXML_Object
{
     ...
     */
    public const XML_PRESERVE = QuickBooks_XML::XML_PRESERVE;

    /**
     * QuickBooks XML parser option - drop empty XML elements
     */
    public const XML_DROP = QuickBooks_XML::XML_DROP;

    /**
     * QuickBooks XML parser option - compress /> empty XML elements
     */
    public const XML_COMPRESS = QuickBooks_XML::XML_COMPRESS;
        ...
        if (true) { 		//class_exists($class, false))
            ...
            switch ($Object->object()) {
                case QUICKBOOKS_OBJECT_RECEIVEPAYMENT:
                    ...
                    $children = [
                        'AppliedToTxnRet' => [ 'QuickBooks_QBXML_Object_ReceivePayment_AppliedToTxn', 'addAppliedToTxn' ],
                        ];
                ...
                case QUICKBOOKS_OBJECT_BILL:
                    ...
                    $children = [
                        'ItemLineRet' => [ 'QuickBooks_QBXML_Object_Bill_ItemLine', 'addItemLine' ],
                        'ExpenseLineRet' => [ 'QuickBooks_QBXML_Object_Bill_ExpenseLine', 'addExpenseLine' ],
                        ];
                ...
                case QUICKBOOKS_OBJECT_PURCHASEORDER:
                    ...
                    $children = [
                        'PurchaseOrderLineRet' => [ 'QuickBooks_QBXML_Object_PurchaseOrder_PurchaseOrderLine', 'addPurchaseOrderLine' ],
                        ];
                ...
                case QUICKBOOKS_OBJECT_INVOICE:
                    ...
                    $children = [
                        'InvoiceLineRet' => [ 'QuickBooks_QBXML_Object_Invoice_InvoiceLine', 'addInvoiceLine' ],
                        ];
                ...
                case QUICKBOOKS_OBJECT_ESTIMATE:
                    ...
                    $children = [
                        'EstimateLineRet' => [ 'QuickBooks_QBXML_Object_Estimate_EstimateLine', 'addEstimateLine' ],
                        ];
                ...
                case QUICKBOOKS_OBJECT_SALESRECEIPT:
                    ...
                    $children = [
                        'SalesReceiptLineRet' => [ 'QuickBooks_QBXML_Object_SalesReceipt_SalesReceiptLine', 'addSalesReceiptLine' ],
                        ];
                ...
                case QUICKBOOKS_OBJECT_JOURNALENTRY:
                    ...
                    $children = [
                        'JournalCreditLineRet' => [ 'QuickBooks_QBXML_Object_JournalEntry_JournalCreditLine', 'addCreditLine' ],
                        'JournalDebitLineRet' => [ 'QuickBooks_QBXML_Object_JournalEntry_JournalDebitLine', 'addDebitLine' ],
                        ];
                ...
                case QUICKBOOKS_OBJECT_SALESTAXGROUPITEM:
                    ...
                    $children = [
                        'ItemSalesTaxRef' => [ 'QuickBooks_QBXML_Object_SalesTaxGroupItem_ItemSalesTaxRef', 'addItemSalesTaxRef' ],
                        ];
                ...
                case QUICKBOOKS_OBJECT_UNITOFMEASURESET:
                    ...
                    $children = [
                        'RelatedUnit' => [ 'QuickBooks_QBXML_Object_UnitOfMeasureSet_RelatedUnit', 'addRelatedUnit' ],
                        'DefaultUnit' => [ 'QuickBooks_QBXML_Object_UnitOfMeasureSet_DefaultUnit', 'addDefaultUnit' ],
                        ];
