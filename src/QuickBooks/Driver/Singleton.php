...
class QuickBooks_Driver_Singleton
{
     ...
     */
    public static function getInstance($dsn_or_conn = null, $options = [], $hooks = [], $log_level = null)
    {
     ...
     *
     */
    public static function initialize($dsn_or_conn, $options = [], $hooks = [], $log_level = null)
    {
